...
- 📺 [vlm-post-training-interface](https://github.com/chloepilonv/post-train-app) - An intertface to make it easier to post-train (full SFT, or Lora/QLora) a VLM for a project I am working on, and manually labelled my DIY video datasets in the llava dataset format.
